    ...
    function showValue_phone() {
      ...
      document.getElementById("console_phone").value = maskMgr.getValue("ic_number");
                                         ...
                                         <div class="col-lg-6">
                                            ...
                                            <div class="mb-5">
                                                    <input type="text" id="old_ic" class="form-control form-control-solid" placeholder="AA 123456" title="AA 123456" input-mask="__ ______" style="background-color: #eeeeee" />
                                                <script>
    function InputMask(element) {
      var self = this;
