...
$pageDescription = "This is the Tentang Kami page of our website.";
...
<main id="primary" class="site-main main-about">
    ...
    <section class="section4" style="background-image: url('img/about-sect4-bg.jpg')">
        <div class="container">
            <div class="content">
